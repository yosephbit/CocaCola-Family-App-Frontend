...
function PlayersPage() {
    return (
        <div className="page players fl-col justify-center align-center">
            ...
            <div className="fl-col align-center w-full round-table">
                <div className="row row--1">
                    <div className="tiger tiger--1"><img src={grandpa} alt="" className="tiger__img" /></div>
                    <div className="tiger tiger--2"><img src={grandma} alt="" className="tiger__img" /></div>
                </div>
                <div className="row row--2">
                    <div className="tiger tiger--3"><img src={father} alt="" className="tiger__img" /></div>
                    <div className="tiger tiger--4"><img src={father} alt="" className="tiger__img" /></div>
                </div>
                <div className="row row--3">
                    <div className="tiger tiger--5"><img src={sister} alt="" className="tiger__img" /></div>
                    <div className="tiger tiger--6"><img src={brother} alt="" className="tiger__img" /></div>
                </div>
            </div>
